...
function portfolio_custom_post() { 
	...
	register_post_type( 'portfolio', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'add_new_item' => __( 'Add New Portfolio Posts', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Edit Portfolio Posts', 'bonestheme' ), /* Edit Display Title */
			...
			'description' => __( 'This is a Portfolio Post.', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
